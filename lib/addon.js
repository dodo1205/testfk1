...
const manifest = {
    ...
    background: '', 
    catalogs: [
        { id: 'fankai-tout', name: 'Fankai - Tout', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-terminees', name: 'Fankai - Terminées', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-encours', name: 'Fankai - En cours', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-ajour', name: 'Fankai - À jour', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-genre-action', name: 'Genres - Action', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-genre-aventure', name: 'Genres - Aventure', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-genre-comedie', name: 'Genres - Comédie', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-genre-drame', name: 'Genres - Drame', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-genre-fantasy', name: 'Genres - Fantasy', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-genre-romance', name: 'Genres - Romance', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-genre-shonen', name: 'Genres - Shonen', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-genre-shojo', name: 'Genres - Shojo', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] }
    ],
...
builder.defineCatalogHandler(async ({ type, id, extra }) => {
    ...
    try {
        ...
        if (id === 'fankai-tout') {
            ...
            const genre = id.split('-')[2].charAt(0).toUpperCase() + id.split('-')[2].slice(1);
            filteredAnimes = visibleAnimes.filter(anime => anime.genres && anime.genres.includes(genre));
        }
