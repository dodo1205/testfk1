...
const manifest = {
    ...
    background: '', 
    catalogs: [
        { id: 'fankai-anime-tout', name: 'Tout', type: 'fankai-anime', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-anime-terminees', name: 'Terminées', type: 'fankai-anime', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-anime-encours', name: 'En cours', type: 'fankai-anime', extra: [ { name: 'search', isRequired: false } ] },
        { id: 'fankai-anime-ajour', name: 'À jour', type: 'fankai-anime', extra: [ { name: 'search', isRequired: false } ] }
    ],
    resources: ['catalog', 'stream', 'meta'], 
    types: ['series', 'movie', 'fankai-anime'],
    idPrefixes: ['fankai:'],
    behaviorHints: {
        adult: false,
        configurable: true,
...
builder.defineCatalogHandler(async ({ type, id, extra }) => {
    ...
    if (!id.startsWith('fankai-anime')) return { metas: [] };
    try {
        ...
        // Filtering logic based on id... (omitted for brevity, assumed correct)
        const metas = filteredAnimes.map(anime => {
            ...
            return {
                id: `fankai:${animeId}`, type: 'fankai-anime', name: anime.title || 'Anime sans titre',
...
builder.defineMetaHandler(async ({ type, id }) => {
    ...
    try {
        ...
        const meta = {
            id: `fankai:${anime.id}`, type: 'fankai-anime', name: anime.title || 'Anime sans titre',
