...
const manifest = {
    ...
    background: '', 
    catalogs: [
        { id: 'fankai-tout', name: 'Tout', type: 'fankai', extra: [ { name: 'search', isRequired: false }, { name: 'genre', isRequired: false, options: ['Action', 'Aventure', 'Comédie', 'Drame', 'Fantasy', 'Horreur', 'Romance', 'Sci-Fi', 'Shonen', 'Shojo', 'Sport'] } ] },
        { id: 'fankai-terminees', name: 'Terminées', type: 'fankai', extra: [ { name: 'search', isRequired: false }, { name: 'genre', isRequired: false, options: ['Action', 'Aventure', 'Comédie', 'Drame', 'Fantasy', 'Horreur', 'Romance', 'Sci-Fi', 'Shonen', 'Shojo', 'Sport'] } ] },
        { id: 'fankai-encours', name: 'En cours', type: 'fankai', extra: [ { name: 'search', isRequired: false }, { name: 'genre', isRequired: false, options: ['Action', 'Aventure', 'Comédie', 'Drame', 'Fantasy', 'Horreur', 'Romance', 'Sci-Fi', 'Shonen', 'Shojo', 'Sport'] } ] },
        { id: 'fankai-ajour', name: 'À jour', type: 'fankai', extra: [ { name: 'search', isRequired: false }, { name: 'genre', isRequired: false, options: ['Action', 'Aventure', 'Comédie', 'Drame', 'Fantasy', 'Horreur', 'Romance', 'Sci-Fi', 'Shonen', 'Shojo', 'Sport'] } ] }
    ],
...
builder.defineCatalogHandler(async ({ type, id, extra }) => {
    ...
    try {
        ...
        if (genreFilter) {
            filteredAnimes = filteredAnimes.filter(anime => anime.genres && anime.genres.some(genre => genre.toLowerCase() === genreFilter.toLowerCase()));
